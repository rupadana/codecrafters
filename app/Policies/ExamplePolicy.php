...
class ExamplePolicy
{
    ...
    {
        return $user->can('delete_any_example');
    }
    ...
    {
        return $user->can('force_delete_any_example');
    }
    ...
    {
        return $user->can('restore_any_example');
    }
     ...
     * @return bool
     */
    public function replicate(User $user, Example $example): bool
    {
        return $user->can('replicate_example');
    }
    ...
    {
        return $user->can('reorder_example');
    }
